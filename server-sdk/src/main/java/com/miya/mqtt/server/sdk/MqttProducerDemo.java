...
public class MqttProducerDemo {
    public static void main(String[] args) throws Exception {
         ...
         */
        // String firstTopic = MqttConsts.DEMO_PARENT_TOPIC + MqttConsts.TOPIC_SEPERATOR + "broadcast";
        String firstTopic = MqttConsts.DEMO_P2P_TOPIC_POSTFIX + MqttConsts.TOPIC_SEPERATOR + "GID_DEMO@@@receive001";
        // String firstTopic = MqttConsts.DEMO_PARENT_TOPIC + MqttConsts.TOPIC_SEPERATOR + "s2m" + MqttConsts.TOPIC_SEPERATOR + "receive001";
        ...
        for (int i = 0; i < 100; i++) {
            ...
            System.out.println("MqttProducerDemo#main topic=" + mqttTopic);
